...
namespace Params {
    ...
    inline const std::map<Names, juce::String> &GetParamNames() {
        static std::map<Names, juce::String> params = {
            ...
            {AttackL,          "Low Band Attack"},
            {AttackM,          "Mid Band Attack"},
            {AttackH,          "High Band Attack"},
            ...
            {ThresholdL,       "Low Band Threshold"},
            {ThresholdM,       "Mid Band Threshold"},
            {ThresholdH,       "High Band Threshold"},
